...
/* Checkout notice, ONE STRING, ONE PLACE, still shared -- read by every
   ...
   out and none of them may come back without a decision behind it:
     ...
     - "Prices shown are current guide prices" -- under the sitewide price
       switch (deleted 15 September 2026 by A2; see isSaleLive() in
...
function nav(current) {
  ...
  <div class="shell nav-inner">
    <a href="/index.html" aria-label="Opsteady, home">
...
const PACKAGE_ITEMS = [
  { key: "training", label: "Primer", verb: "Learn it", copy: "Start with little or no prior knowledge. The primer gets you ready to understand the subject and use the module with confidence." },
