...
w("terms.html", page({
  ...
  <section class="page-section full-copy">
    <div class="shell">
      ...
      <p>Each module is a digital download: an Excel spreadsheet or workbook, plus a written guide, delivered as a PDF. Module pages state what's included. Nothing physical is shipped.</p>
      <h2>6. Price</h2>
  ...
  <section class="page-section full-copy">
    <div class="shell">
      ...
      <ul>
        ...
        <li><strong>Lemon Squeezy</strong> will handle any purchase, and will hold your details as part of that, once buying is possible &mdash; it is not yet, so no payment provider holds anything about you today</li>
      </ul>
